        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Members_Instructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructors",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupClassMembers", x => new { x.GroupClassId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_GroupClassMembers_GroupClasses_GroupClassId",
                        column: x => x.GroupClassId,
                        principalTable: "GroupClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupClassMembers_Members_MembersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PtSessions_Instructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PtSessions_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupClassMembers_MembersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PtSessions_InstructorId",
                table: "PtSessions",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_PtSessions_MemberId",
                table: "PtSessions",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptions_UserId_SubscriptionId",
                table: "UserSubscriptions",
